...
<link
    href="<?php echo $baseUrl; ?>web/css/template_colors.css"
...
<div id="header">
    ...
    <div id="banner">
        <div class="moduletable">
            <p><strong><strong>High School</strong>: </strong>Add your name<strong> City: </strong>Cincinnati<strong>
                    State: </strong>Ohio<br/><strong>Height</strong>: 6'3"&nbsp;<strong>Weight</strong>: 193
                <strong>SAT</strong>: 1500 <strong>GPA</strong>: 4.0 <strong>Honor Roll</strong>: All 4
                years<br/><strong>Sports</strong>: Baseball &amp; Football <strong>Positions</strong>: Pitcher &amp;
                Quarterback</p></div>
    </div>
</div>
<!--end header-->
...
<link rel="stylesheet" href="<?php echo $baseUrl; ?>web/css/slide-style.css" type="text/css" media="screen"/>
<script type="text/javascript">var _siteRoot = 'index.html', _root = 'index.html';</script>
<script type="text/javascript" src="<?php echo $baseUrl; ?>web/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl; ?>web/js/slide-scripts.js"></script>
