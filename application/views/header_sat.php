...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    เพื่อนช่าง, จานดาวเทียม นครปฐม, CCTV, CCTV นครปฐม, กล้องวงจรปิด นครปฐม, CCTV นครปฐม<?php echo $keyword; ?>'/>
        ...
        <![endif]-->
        <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>web/css/trans-menu_sat.css"/>

        <!--    <link href="-->
        <?php //echo $baseUrl; ?><!--web/css/rokmoomenu.css" rel="stylesheet" type="text/css"/>-->
        <link href="<?php echo $baseUrl; ?>web/css/template_css_sat.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo $baseUrl; ?>web/css/template_colors_sat.css" rel="stylesheet" type="text/css"/>
