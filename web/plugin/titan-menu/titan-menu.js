...
(function (e, t, n, r) {
    e.fn.titanMenu = function (r) {
        r = e.extend({}, e.fn.titanMenu.options, r);
        return this.each(function () {
            var i = e(this);
            var s = e("> li", i);
            var o = e("> li", i);
            var u = e("> li.split > div", i);
            var a = e("li li", i);
            var f = e("li.tmgodown", i);
            var l = e("> li > div > ul, > li > ul", i);
            var c = e("ul", i);
            var h = e("> li > div > ul", i);
            var p = r.distance + i.height();
            var d = p;
            var v = p;
            var m = r.zindex - 1;
            var g = r.delay;
            ...
            var C = r.icons;
            destroyAll = true;
            if ("ontouchstart"in t || t.DocumentTouch && n instanceof DocumentTouch) {
                var k = "touchstart";
                var L = true
            } else {
                k = "click";
            ...
            i.addClass("tm-" + E).find("div").css({opacity: S}).css({zIndex: m});
            i.css({zIndex: x});
            if (T == "left" && b != "stack") {
                s.hover(function () {
                    var t = e(this).width() - 29;
                    e(this).children("div").children("ul").css({left: "-" + t + "px"})
                })
            } else if (T == "right" && b != "stack") {
                h.css({right: "-133px"})
            } else if (b == "stack") {
                h.css({right: "-" + O + "px", top: "-1px"})
            }
            if (C == "no") {
                a.children("a").css({width: "150px", border: "none"})
            }
            if (N == "click" || L === true) {
                o.on(k, function (t) {
                    if (!e(this).hasClass("split")) {
                        if (e(this).hasClass("active")) {
                            if (y == "slidefade") {
                                e(this).removeClass("active").children("div").children("ul:first").stop(true, true).delay(g).animate({height: "toggle", opacity: "toggle"}, D)
                            } else {
                                e(this).removeClass("active").children("div").children("ul:first").stop(true, true).delay(g)[_](D)
                            }
                            e(".titanmenu").find(".active").removeClass("active")
                        } else {
                            e(".titanmenu").find(".active").removeClass("active").find("ul").hide();
                            e(".titanmenu").find(".active").removeClass("active").find("ul").hide();
                            if (y == "slidefade") {
                                e(this).addClass("active").children("div").children("ul:first").stop(true, true).animate({height: "toggle", opacity: "toggle"}, D)
                            } else {
                                e(this).addClass("active").children("div").children("ul:first").stop(true, true)[M](D)
                            }
                        }
                    }
                    e(".titanmenu a").blur();
                ...
                u.on(k, function (t) {
                    if (!e(this).hasClass("nosplit")) {
                        if (e(this).parents("li").hasClass("active")) {
                            e(".titanmenu").find(".active").removeClass("active");
                            if (y == "slidefade") {
                                e(this).children("ul:first").stop(true, true).delay(g).animate({height: "toggle", opacity: "toggle"}, D)
                            } else {
                                e(this).children("ul:first").stop(true, true).delay(g)[_](D)
                            }
                        } else {
                            s.find("ul").hide();
                            e(".titanmenu").find(".active").removeClass("active");
                            e(this).parents(".split").addClass("active");
                            if (y == "slidefade") {
                                e(this).children("ul:first").stop(true, true).animate({height: "toggle", opacity: "toggle"}, D)
                            } else {
                                e(this).children("ul:first").stop(true, true)[M](D)
                            }
                        }
                    }
                    e(".titanmenu a").blur();
                ...
                o.mouseenter(function () {
                    if (!e(this).hasClass("split")) {
                        if (y == "slidefade") {
                            e(this).children("div").children("ul:first").stop(true, true).animate({height: "toggle", opacity: "toggle"}, D)
                        } else {
                            e(this).children("div").children("ul:first").stop(true, true)[M](D)
                        }
                    }
                });
                o.mouseleave(function () {
                    ...
                    if (!e(this).hasClass("split")) {
                        if (y == "slidefade") {
                            e(this).children("div").children("ul:first").stop(true, true).delay(g).animate({height: "toggle", opacity: "toggle"}, D)
                        } else {
                            e(this).children("div").children("ul:first").stop(true, true).delay(g)[_](D)
                        }
                    }
                });
            ...
            if (N == "click" || L == true) {
                a.on(k, function (t) {
                    if (!e(this).hasClass("tmgodown")) {
                        if (e(this).children("ul:first").is(":hidden")) {
                            e(this).parent("ul").children("li").removeClass("active").find("ul").not(e(this)).hide();
                            if (y == "slidefade") {
                                e(this).addClass("active").children("ul").stop(true, true).animate({height: "toggle", opacity: "toggle"}, D)
                            } else {
                                e(this).addClass("active").children("ul").stop(true, true)[M](D)
                            }
                        } else {
                            if (y == "slidefade") {
                                e(this).removeClass("active").children("ul").stop(true, true).delay(g).animate({height: "toggle", opacity: "toggle"}, D).hide(400)
                            } else {
                                e(this).removeClass("active").children("ul").stop(true, true).delay(g)[_](D).hide(400)
                            }
                        }
                    }
                    destroyAll = true;
                ...
                a.mouseenter(function () {
                    if (!e(this).hasClass("tmgodown")) {
                        if (y == "slidefade") {
                            e(this).children("ul").stop(true, true).animate({height: "toggle", opacity: "toggle"}, D)
                        } else {
                            e(this).children("ul").stop(true, true)[M](D)
                        }
                    }
                });
                a.mouseleave(function () {
                    if (!e(this).hasClass("tmgodown")) {
                        if (y == "slidefade") {
                            e(this).children("ul").stop(true, true).delay(g).animate({height: "toggle", opacity: "toggle"}, D).hide(400)
                        } else {
                            e(this).children("ul").stop(true, true).delay(g)[_](D).hide(400)
                        }
                    }
                })
            }
            if (b != "stack") {
                s.mouseenter(function () {
                    ...
                    e(this).children("div").prepend('<div class="tmbridge" style="width:' + t + "px;height:" + d + "px;bottom:-" + v + 'px"/>')
                });
                s.mouseleave(function () {
                    e(this).find(".tmbridge").remove()
                })
            }
            f.on(k, function (t) {
                if (e(this).children("ul").is(":hidden")) {
                    e(this).parent("ul").children("li").removeClass("active").find("ul").not(e(this)).hide();
                    e(this).addClass("active").children("ul:first").stop(true, true).slideDown(D);
                    e(this).children("span").children().remove()
                } else {
                    e(this).removeClass("active").children("ul").stop(true, true).delay(g).slideUp(D);
                    e(this).children("span").prepend("<span></span>")
                }
                destroyAll = true;
                t.stopPropagation()
            });
            e(n).on(k, this, function (t) {
                if (destroyAll === true) {
                    if (!e(t.target).is(e(".titanmenu")) && !e(t.target).is(e(".titanmenu *"))) {
                        e(".titanmenu").children("ul").find("ul").hide();
                        e(".titanmenu").find(".active").removeClass("active");
                        e(".titanmenu").find(".tmbridge").remove();
                        e(".titanmenu a").blur();
                        destroyAll = false
                    }
                }
    ...
    e.fn.titanMenu.options = {effect: "none", speed: 200, style: "black", layout: "button", distance: 0, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"}
})(jQuery, window, document);
jQuery.noConflict()(document).ready(function (e) {
//    e("#demo-1").titanMenu({effect: "fade", speed: 100, style: "black", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 200, eventType: "hover"});
    e("#demo-2").titanMenu({
        effect: 'fade',   //effect
            speed: 300,       //speed of effect
            style: 'red',   //color setting
            layout: 'stack', //layout type
            distance: 9,      //distance between button and box
...
//    e("#demo-3").titanMenu({effect: "fade", speed: 100, style: "darkblue", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-4").titanMenu({effect: "fade", speed: 500, style: "lightblue", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-5").titanMenu({effect: "none", speed: 100, style: "red", layout: "button", distance: 9, opacity: 1, "float": "left", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-6").titanMenu({effect: "slide", speed: 400, style: "orange", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "no", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-7").titanMenu({effect: "fade", speed: 100, style: "green", layout: "bar", distance: 11, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-8").titanMenu({effect: "fade", speed: 100, style: "darkgrey", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-9").titanMenu({effect: "fade", speed: 100, style: "violet", layout: "button", distance: 9, opacity: 1, "float": "left", icons: "yes", zindex: 100, delay: 0, eventType: "hover"});
//    e("#demo-10").titanMenu({effect: "fade", speed: 100, style: "purple", layout: "button", distance: 9, opacity: 1, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "click"});
//    e("#demo-11").titanMenu({effect: "fade", speed: 100, style: "brown", layout: "button", distance: 9, opacity: .9, "float": "right", icons: "yes", zindex: 100, delay: 0, eventType: "hover"})
})