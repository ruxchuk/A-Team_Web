...
//            autoPlay: true,
    ...
    E("<div>").css({width: "100%", visibility: "hidden", "font-size": 0, "line-height": 0}).append(a.find("li:first img:first").clone().css({width: "100%"})).prependTo(a);
    ...
    if (y.preventCopy && !/iPhone/.test(navigator.platform)) {
        G = E('<div><a href="#" style="display:none;position:absolute;left:0;top:0;width:100%;height:100%"></a></div>').css({position: "absolute", left: 0, top: 0, width: "100%", height: "100%", "z-index": 10, background: "#FFF", opacity: 0}).appendTo(l).find("A").get(0)
    }
    var h = [];
    j.each(function (c) {
    ...
    var W = Y ? E("<A>") : Y;
    if (W) {
        W.css({position: "relative", display: "block", "background-color": "#E4EFEB", color: "#837F80", "font-family": "Lucida Grande,sans-serif", "font-size": "11px", "font-weight": "normal", "font-style": "normal", "-moz-border-radius": "5px", "border-radius": "5px", padding: "1px 5px", width: "auto", height: "auto", margin: "0 0 0 0", outline: "none"}).attr({href: "http://" + e.toLowerCase()}).html(e).bind("contextmenu",function (c) {
            return false
        ...
        if (m.length) {
            ...
            if (f.length) {
                ...
                function ac(aj) {
                    ...
                    Z.show();
                    var ak = {left: ae.get(aj).offsetLeft - Z.width() / 2, "margin-top": ae.get(aj).offsetTop - ae.get(0).offsetTop + "px", "margin-bottom": -ae.get(aj).offsetTop + ae.get(ae.length - 1).offsetTop + "px"};
                    var ai = f.get(aj);
                ...
                ag.hover(function () {
                    ...
                    if (document.all) {
                        ...
                        Z.stop().animate({opacity: 0}, {duration: "fast", complete: function () {
                            Z.hide()
                        }})
                    }
                });
        ...
        E("A", M).each(function (aa) {
            if (aa == c) {
                ...
                if (!F) {
                    ...
                    d.stop(true).animate({left: -Math.max(Math.min(Z.left, -ab.left), Z.left + f.width() - M.width()), top: -Math.max(Math.min(Z.top, -ab.top), Z.top + f.height() - M.height())})
                }
            } else {
    ...
    if (L == "move") {
        L = [
            {left1: "100%", top2: "100%"},
            {left1: "80%", left2: "-50%"},
            {top1: "-100%", top2: "100%", distance: 0.7, easing: "easeOutBack"},
    ...
    function z(d) {
        ...
        c.stop(1, 1).stop(1, 1).fadeOut(y.captionDuration / 3, function () {
            if (Z || f) {
                ...
                if (L == "slide") {
                    N(c, {direction: "left", easing: "easeInOutExpo", complete: function () {
                        if (E.browser.msie) {
    ...
    function n(aa, ae, c, ac, f) {
        ...
        function ab(ag) {
            ...
            E(Z[ag]).css({opacity: 0, visibility: "visible"}).animate({opacity: ah}, f, "easeOutCirc").animate({top: 0, left: 0}, {duration: f, easing: (ae.easing || ac), queue: false})
        }
    ...
    function N(ad, ag) {
        ...
        ad.show();
        var ac = {width: w(ad.get(0), 1, 1), height: t(ad.get(0), 1, 1), "float": ad.css("float"), overflow: "hidden", opacity: 0};
        for (var f in af) {
            ac[f] = af[f] || I(ad.get(0), f)
        }
        var d = E("<div></div>").css({fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0});
        ad.wrap(d);
        d = ad.parent();
        ...
        ad.animate(ab, {queue: false, duration: ag.duration, easing: ag.easing, complete: function () {
            ad.css(af);
...
function ws_blast(l, e, h) {
    ...
    function j(r, p, m) {
        ...
        d(r).each(function (x) {
            ...
            d(this).find("img").css({left: -(q * w / c) + "px", top: -(o * u / k) + "px", width: q + "px", height: o + "px"});
    ...
    this.go = function (m, o) {
        ...
        j(g, true, true);
        d(g).animate({opacity: 0}, {queue: false, easing: "easeInOutExpo", duration: l.duration, complete: function () {
...
function ws_blinds(c, b, a) {
    ...
    this.go = function (m, o, j) {
        ...
        for (var n = 0; n < h.length; n++) {
            var k = h[n];
            g(b.get(m)).clone().css({position: "absolute", top: 0, left: (!l ? (-f.width()) : (f.width() - k.position().left)) + "px", width: "auto", height: "100%"}).appendTo(k).animate({left: -k.position().left + "px"}, (c.duration / (h.length + 1)) * (l ? (h.length - n + 1) : (n + 2)), ((!l && n == h.length - 1 || l && !n) ? function () {
...
function ws_kenburns(c, j, k) {
    ...
    var m = c.paths || [
        ...
        {from: [0, 0, 1.2], to: [1, 0, 1.2]},
        {from: [0, 1, 1.2], to: [1, 1, 1.2]},
        {from: [1, 0, 1.2], to: [1, 1, 1.2]},
        {from: [0, 0, 1.2], to: [0, 1, 1.2]},
        {from: [1, 0, 1.2], to: [0, 1, 1.2]},
    ...
    var i = c.width, o = c.height;
    var n;
    var f;
    if (e) {
        var b = d('<canvas width="' + i + '" height="' + o + '"/>');
        b.css({"z-index": 8, position: "absolute", left: 0, top: 0, width: "100%", height: "100%"}).appendTo(k);
        n = b.get(0).getContext("2d")
    } else {
        var b = d('<div style="width:100%;height:100%"></div>');
        b.css({"z-index": 8, position: "absolute", left: 0, top: 0}).appendTo(k);
        var g = [d('<img src="' + j.get(c.startSlide) + '"/>').css({position: "absolute", "z-index": 1}).appendTo(b)];
    ...
    function p(h, v, t) {
        if (n) {
            ...
            if (t) {
                g[s].css({"z-index": 1}).fadeOut(c.duration);
                s = s ? 0 : 1
            }
            var u = g[s].stop(1, 1).attr("src", h.src).css({"z-index": 2, left: "auto", right: "auto", top: "auto", bottom: "auto"}).css(r(v.from, v.from[0] > 0.5, v.from[1] > 0.5)).animate(r(v.to, v.from[0] > 0.5, v.from[1] > 0.5), {easing: "linear", queue: false, duration: (1.5 * c.duration + c.delay)});
            if (t) {
...
function ws_rotate(c, a, b) {
    var f = jQuery;
    var d = f("ul", b);
    var g = {position: "absolute", left: 0, top: 0, width: "100%"};
    var e;
    this.go = function (h, i) {
        ...
        if (!c.noCross) {
            ...
            d.hide();
            j.animate({rotate: c.rotateOut || 180, scale: c.scaleOut || 10, opacity: "hide"}, {duration: c.duration, easing: "easeInOutExpo", complete: function () {
                f(this).remove()
            }})
        }
        e.css({scale: c.scaleIn || 10, rotate: c.rotateIn || (-180), zIndex: 10});
        e.animate({opacity: "show", rotate: 0, scale: 1}, {duration: c.duration, easing: "easeInOutExpo", queue: false, complete: function () {
            d.css({left: -h + "00%"}).show();
            f(this).remove();
            e = 0
        }});
        return h
...
function ws_slices(i, f, g) {
    var c = jQuery;
    var e = function (p, v) {
        var o = c.extend({}, {effect: "random", slices: 15, animSpeed: 500, pauseTime: 3000, startSlide: 0, container: null, onEffectEnd: 0}, v);
        var r = {currentSlide: 0, currentImage: "", totalSlides: 0, randAnim: "", stop: false};
        var m = c(p);
        m.data("wow:vars", r);
        ...
        for (var q = 0; q < o.slices; q++) {
            ...
            var t = c('<div class="wow-slice"></div>').css({left: u * q + "px", overflow: "hidden", width: ((q == o.slices - 1) ? (k.width() - (u * q)) : u) + "px", position: "absolute"}).appendTo(k);
            c("<img>").css({position: "absolute", left: 0, top: 0}).appendTo(t)
        }
        var l = 0;
        ...
        var s = function (w, x, z, B) {
            ...
            c(".wow-slice", k).each(function (H) {
                var J = c(this), G = c("img", J);
                var I = Math.round(k.width() / z.slices);
                G.width(k.width());
                G.attr("src", C.currentImage.attr("src"));
                G.css({left: -I * H + "px"});
                J.css({height: "0px", opacity: "0", left: I * H + "px", width: ((H == z.slices - 1) ? (k.width() - (I * H)) : I) + "px", })
            });
            k.show();
            if (z.effect == "random") {
            ...
            if (z.effect == "sliceDown" || z.effect == "sliceDownRight" || C.randAnim == "sliceDownRight" || z.effect == "sliceDownLeft" || C.randAnim == "sliceDownLeft") {
                ...
                F.each(function () {
                    ...
                    if (A == z.slices - 1) {
                        setTimeout(function () {
                            G.animate({height: "100%", opacity: "1.0"}, z.animSpeed, j)
                        }, (100 + y))
                    } else {
                        setTimeout(function () {
                            G.animate({height: "100%", opacity: "1.0"}, z.animSpeed)
                        }, (100 + y))
                    }
                    y += 50;
                    A++
                    ...
                    if (z.effect == "sliceUpDown" || z.effect == "sliceUpDownRight" || C.randAnim == "sliceUpDownRight" || z.effect == "sliceUpDownLeft" || C.randAnim == "sliceUpDownLeft") {
                        ...
                        if (z.effect == "fold" || C.randAnim == "fold") {
                            ...
                            c(".wow-slice", k).each(function () {
                                var G = c(this);
                                var H = G.width();
                                G.css({top: "0px", height: "100%", width: "0px"});
                                if (A == z.slices - 1) {
                                    setTimeout(function () {
                                        G.animate({width: H, opacity: "1.0"}, z.animSpeed, j)
                                    }, (100 + y))
                                } else {
                                    setTimeout(function () {
                                        G.animate({width: H, opacity: "1.0"}, z.animSpeed)
                                    }, (100 + y))
                                }
                                y += 50;
                                A++
                            ...
                            if (z.effect == "fade" || C.randAnim == "fade") {
                                ...
                                c(".wow-slice", k).each(function () {
                                    ...
                                    if (A == z.slices - 1) {
                                        c(this).animate({opacity: "1.0"}, (z.animSpeed * 2), j)
                                    } else {
                                        c(this).animate({opacity: "1.0"}, (z.animSpeed * 2))
                                    }
                                    A++
                                })
                            }
    ...
    var a = c("li", g);
    var d = c("ul", g);
    var b = c("<div></div>").css({left: 0, top: 0, "z-index": 8, width: "100%", height: "100%", position: "absolute"}).appendTo(g);
    var h = new e(d, {keyboardNav: false, caption: 0, effect: "sliceDownRight,sliceDownLeft,sliceUpRight,sliceUpLeft,sliceUpDownRight,sliceUpDownLeft,sliceUpDownRight,sliceUpDownLeft,fold,fold,fold", animSpeed: i.duration, startSlide: i.startSlide, container: b, onEffectEnd: function (j) {
        d.css({left: -j + "00%"})
    }});
    ...
    (function (g) {
        ...
        g.fn.coinslider = g.fn.CoinSlider = function (q) {
            init = function (r) {
                ...
                m[r.id] = 1;
                a[r.id] = r;
                f[r.id] = g.extend({}, g.fn.coinslider.defaults, q);
                ...
                a[r.id] = g("<div class='coin-slider' id='coin-slider-" + r.id + "' />").css({"background-image": "url(" + n[r.id][q.startSlide || 0].src + ")", "-o-background-size": "100%", "-webkit-background-size": "100%", "-moz-background-size": "100%", "background-size": "100%", width: "100%", height: "100%", position: "relative", "background-position": "top left"}).appendTo(g(r).parent());
                for (i = 1; i <= f[r.id].sph; i++) {
                    for (j = 1; j <= f[r.id].spw; j++) {
                        g(f[r.id].links ? ("<a href='" + p[r.id][0] + "'></a>") : "<div></div>").css({"float": "left", position: "absolute"}).appendTo(a[r.id]).attr("id", "cs-" + r.id + i + j)
                    }
                }
            ...
            g.setFields = function (s) {
                ...
                for (i = 1; i <= f[s.id].sph; i++) {
                    ...
                    for (j = 1; j <= f[s.id].spw; j++) {
                        ...
                        d[s.id][counter] = i + "" + j;
                        counter++;
                        g("#cs-" + s.id + i + j).css({width: sWidth + "px", height: sHeight + "px", "background-position": -sLeft + "px " + (-sTop + "px"), "background-size": r + "px " + t + "px", "-moz-background-size": r + "px " + t + "px", "-o-background-size": r + "px " + t + "px", "-webkit-background-size": r + "px " + t + "px", left: sLeft, top: sTop}).addClass("cs-" + s.id);
                        sLeft += sWidth
                    }
                    sTop += sHeight;
                    sLeft = 0
            ...
            g.transition = function (r, s) {
                ...
                g(a[r.id]).css({"background-image": "url(" + n[r.id][h[r.id]].src + ")"});
                ...
                if (l[r.id][h[r.id]]) {
                    g("#cs-title-" + r.id).css({opacity: 0}).animate({opacity: f[r.id].opacity}, f[r.id].titleSpeed);
            ...
            g.appereance = function (s, r) {
                ...
                g("#cs-" + s.id + r).css({opacity: 0, "background-image": "url(" + n[s.id][h[s.id]].src + ")"});
                g("#cs-" + s.id + r).animate({opacity: 1}, 300);
                b[s.id]++
            };
            g.setNavigation = function (r) {
                ...
                g("#cs-prev-" + r.id).css({position: "absolute", top: f[r.id].height / 2 - 15, left: 0, "z-index": 1001, "line-height": "30px", opacity: f[r.id].opacity}).click(function (s) {
                    s.preventDefault();
                    g.transition(r, "prev");
                    g.transitionCall(r)
                }).mouseover(function () {
                ...
                g("#cs-buttons-" + r.id).css({left: "50%", "margin-left": -n[r.id].length * 15 / 2 - 5, position: "relative"})
            };
            g.effect = function (r) {
        ...
        g.fn.coinslider.defaults = {width: 565, height: 290, spw: 7, sph: 5, delay: 3000, sDelay: 30, opacity: 0.7, titleSpeed: 500, effect: "", navigation: true, links: true, hoverPause: true}
    })(jQuery)
}
;
function ws_squares(c, a, b) {
    ...
    var h = 0;
    g(e).coinslider({hoverPause: false, startSlide: c.startSlide, navigation: 0, delay: -1, width: c.width, height: c.height});
    var f = g("#coin-slider-" + e.id).css({position: "absolute", left: 0, top: 0, "z-index": 8});
    var d = c.startSlide;
...
function ws_stack(d, a, b) {
    ...
    this.go = function (k, h, n, m) {
        ...
        var f = e(c.get(g ? k : h)).clone().css({position: "absolute", "z-index": 4, width: "100%", top: 0, left: ((g ? i : l))});
        if (g) {
            f.appendTo(b)
        } else {
            f.insertAfter(j)
        ...
        if (!g) {
            e("ul", b).css({left: -k + "00%"})
        }
        f.animate({left: (g ? l : i)}, d.duration, "easeInOutExpo", function () {
            if (g) {
                j.css({left: -k + "00%"})
            }
            e(this).remove()
